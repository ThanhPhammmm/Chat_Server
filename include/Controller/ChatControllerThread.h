...
class ChatControllerThread{
    ...
    public:
        ChatControllerThread(std::shared_ptr<MessageQueue<Message>> incoming_queue, std::shared_ptr<MessageQueue<HandlerResponsePtr>> response_queue, EpollInstancePtr epoll_instance);
